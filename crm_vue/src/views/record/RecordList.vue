                ...
                <el-main class="main">
                    ...
                    <el-page-header @back="goBack">
                        ...
                        <template #content>
                            ...
                            <span style="margin-left:30px;"><el-button type="primary" @click="exportschool">导出所有费用记录</el-button></span>
                        </template>
                    </el-page-header>
                    <el-divider/>
                    <div class="box">
                        <el-table :data="schools" style="width: 100%">
                            ...
                            <el-table-column prop="schoolAddress" label="所在国家"/>
                            <el-table-column prop="schoolType" label="学校类型"/>
                            <el-table-column prop="contract" label="相关文件"/>
...
const exportschool = async ()=>{
    const response = await fetch(api.school.allschool, {
          method: 'POST',
          headers: {
        ...
        console.log(data)
        // data.schools
        const worksheet = XLSX.utils.json_to_sheet(data.schools);
...
const getschool_by_page = async (page: number)=>{
    const response = await fetch(api.school.schoollist, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
